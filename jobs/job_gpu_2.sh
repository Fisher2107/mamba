...
python tsp.py --save_loc 'checkpoints/gpu/city_count_point/mamba2_120' --nb_layers 3  --nb_epochs 5 --city_count 120 --recycle_data 5 --mamba2 True --pynvml True --gpu_id $CUDA_VISIBLE_DEVICES --wandb --bsz 50 --reverse True
...
python tsp.py --save_loc 'checkpoints/gpu/city_count_point/mamba2_120_d16' --nb_layers 3  --nb_epochs 5 --city_count 120 --recycle_data 5 --mamba2 True --pynvml True --gpu_id $CUDA_VISIBLE_DEVICES --wandb --bsz 50 --reverse True --d_model 16
...
python tsp.py --save_loc 'checkpoints/gpu/city_count_point/mamba2_120_lay1' --nb_layers 1  --nb_epochs 5 --city_count 120 --recycle_data 5 --mamba2 True --pynvml True --gpu_id $CUDA_VISIBLE_DEVICES --wandb --bsz 50 --reverse True
...
python tsp.py --save_loc 'checkpoints/gpu/city_count_point_ng/mamba2_120' --nb_layers 3  --nb_epochs 5 --city_count 120 --recycle_data 5 --mamba2 True --mlp_cls 'identitiy' --pynvml True --gpu_id $CUDA_VISIBLE_DEVICES --wandb --bsz 50 --reverse True
...
python tsp.py --save_loc 'checkpoints/gpu/city_count_point_ng/mamba2_120_d16' --nb_layers 3  --nb_epochs 5 --city_count 120 --recycle_data 5 --mamba2 True --mlp_cls 'identitiy' --pynvml True --gpu_id $CUDA_VISIBLE_DEVICES --wandb --bsz 50 --reverse True --d_model 16
...
python tsp.py --save_loc 'checkpoints/gpu/city_count_point_ng/mamba2_120_lay1' --nb_layers 1  --nb_epochs 5 --city_count 120 --recycle_data 5 --mamba2 True --mlp_cls 'identitiy' --pynvml True --gpu_id $CUDA_VISIBLE_DEVICES --wandb --bsz 50 --reverse True