...
plt.plot(mean_tour_length_list2[4000:], label='Transferred weights from city count 10')
#plt.plot(mean_tour_length_list3, label='No Transfer')
#plt.plot(mean_tour_length_list4[4000:], label='Transferred weights from city count 20')
...
plt.legend()
plt.savefig('figs/scale/transfer/20_transfer.pdf')
#plt.show()