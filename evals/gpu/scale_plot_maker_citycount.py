...
csv_files= ['../../checkpoints/gpu/tour/mamba2_5_gpu_stats.csv',
              '../../checkpoints/gpu/tour/mamba2_10_gpu_stats.csv', 
              '../../checkpoints/gpu/tour/mamba2_20_gpu_stats.csv', 
              '../../checkpoints/gpu/tour/mamba2_50_gpu_stats.csv', 
              '../../checkpoints/gpu/tour/mamba2_75_gpu_stats.csv',
              '../../checkpoints/gpu/tour/mamba2_100_gpu_stats.csv',
              '../../checkpoints/gpu/tour/mamba2_120_gpu_stats.csv',]

csv_files_16 = ['../../checkpoints/gpu/tour/mamba2_5_d16_gpu_stats.csv',
              '../../checkpoints/gpu/tour/mamba2_10_d16_gpu_stats.csv', 
              '../../checkpoints/gpu/tour/mamba2_20_d16_gpu_stats.csv', 
              '../../checkpoints/gpu/tour/mamba2_50_d16_gpu_stats.csv', 
              '../../checkpoints/gpu/tour/mamba2_75_d16_gpu_stats.csv',
              '../../checkpoints/gpu/tour/mamba2_100_d16_gpu_stats.csv',
                '../../checkpoints/gpu/tour/mamba2_120_d16_gpu_stats.csv']

csv_files_lay1 = ['../../checkpoints/gpu/tour/mamba2_5_lay1_gpu_stats.csv',
              '../../checkpoints/gpu/tour/mamba2_10_lay1_gpu_stats.csv', 
              '../../checkpoints/gpu/tour/mamba2_20_lay1_gpu_stats.csv', 
              '../../checkpoints/gpu/tour/mamba2_50_lay1_gpu_stats.csv', 
              '../../checkpoints/gpu/tour/mamba2_75_lay1_gpu_stats.csv',
              '../../checkpoints/gpu/tour/mamba2_100_lay1_gpu_stats.csv',
                '../../checkpoints/gpu/tour/mamba2_120_lay1_gpu_stats.csv']

csv_files_ng = ['../../checkpoints/gpu/tour/mamba2_5_ng_gpu_stats.csv',
              '../../checkpoints/gpu/tour/mamba2_10_ng_gpu_stats.csv', 
              '../../checkpoints/gpu/tour/mamba2_20_ng_gpu_stats.csv', 
              '../../checkpoints/gpu/tour/mamba2_50_ng_gpu_stats.csv', 
...
generate_plot(csv_files,csv_files_16,csv_files_lay1,csv_files_ng,'../figs/scale/memory_usage_tour.pdf')