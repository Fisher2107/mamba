...
def generate_plot(csv_files64,csv_files16):
    x_values64 = [5, 10, 20, 50, 75, 100]
    x_values16 = [5, 10, 20, 50, 100]
    y_values_64 = []
    y_values_16 = []
    ...
    #plot
    plt.plot(x_values64, y_values_64, marker='o', linestyle='None', label='dim = 64')
    plt.plot(x_values16, y_values_16, marker='o', linestyle='None', label='dim = 16')
