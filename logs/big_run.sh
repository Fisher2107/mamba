...
python tsp.py --save_loc 'checkpoints/big/64_NG_city10'         --nb_layers 3  --nb_epochs 4000  --mamba2 True --city_count 20 --nb_batch_per_epoch 10 --bsz 5000 --last_layer 'pointer' --reverse True --mlp_cls 'identity'
