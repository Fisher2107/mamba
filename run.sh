...
python tsp.py --save_loc 'checkpoints/mamba2/mamba2_3lay' --nb_epochs 1000 --nb_layers 3 --mamba2 True
python tsp.py --save_loc 'checkpoints/mamba2/mamba2_4lay' --nb_epochs 1000 --nb_layers 4 --mamba2 True
