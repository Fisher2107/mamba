...
python tsp.py --save_loc 'checkpoints/mamba2/mamba2_4lay' --nb_epochs 1000 --nb_layers 4 --mamba2 True  --reverse True --d_model 128 --city_count 10
python tsp.py --save_loc 'checkpoints/mamba2/mamba_3lay' --nb_epochs 1000 --nb_layers 3 --mamba2 True --d_model 128 --city_count 10
python tsp.py --save_loc 'checkpoints/mamba2/mamba_4lay' --nb_epochs 1000 --nb_layers 4 --mamba2 True  --d_model 128 --city_count 10
