...
python tsp.py --save_loc 'checkpoints/mamba2/mamba2_4lay' --nb_epochs 1000 --nb_layers 4 --mamba2 True  --reverse True --d_model 128 --city_count 10 --nb_epochs 2000 --checkpoint 'checkpoints/mamba2/mamba2_4lay_22-06_17-16.pt'
