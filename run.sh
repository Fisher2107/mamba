...
python tsp.py --save_loc 'checkpoints/abalation/city20'  --nb_epochs 10000  --mamba2 True --city_count 20 --nb_batch_per_epoch 10  --bsz 600 --reverse True  --project_name 'Abalation' --d_model 128 --nb_layers 1 --wandb
python tsp.py --save_loc 'checkpoints/abalation/city20'  --nb_epochs 10000  --mamba2 True --city_count 20 --nb_batch_per_epoch 10  --bsz 600 --reverse True  --project_name 'Abalation' --d_model 256 --nb_layers 1 --wandb
python tsp.py --save_loc 'checkpoints/abalation/city20'  --nb_epochs 10000  --mamba2 True --city_count 20 --nb_batch_per_epoch 10  --bsz 600 --reverse True  --project_name 'Abalation' --d_model 128 --wandb
python tsp.py --save_loc 'checkpoints/abalation/city20'  --nb_epochs 10000  --mamba2 True --city_count 20 --nb_batch_per_epoch 10  --bsz 600 --reverse False  --project_name 'Abalation' --d_model 128 --wandb
