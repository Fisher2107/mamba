...
python tsp.py --save_loc 'checkpoints/reverse/Linear_3' --nb_epochs 1000 --nb_layers 3
...
python tsp.py --save_loc 'checkpoints/reverse/Linear_5' --nb_epochs 1000 --nb_layers 5
